<%-- 
    Document   : Home
    Created on : Aug 10, 2021, 3:55:05 PM
    Author     : Thanh Dang
--%>
        ...
        <div class="container-xxl">
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <c:choose>
                        <c:when test="${allProducts == null || allProducts.size() <= 0}">
                            <h3>Not Found!</h3>
                        </c:when>
                        <c:otherwise>
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <c:forEach items="${allProducts}" var="i">
                                        <tr>
                                            <td>${i.getId()}</td>
                                            <td>${i.getName()}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="DeleteProduct?id=${i.getId()}" class="delete" onclick="return confirm('Are you sure you want to delete this record?')"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
